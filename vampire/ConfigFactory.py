...
#         return file_string
    ...
    #     return _file_string
    #
    # def _generate_modis_extract(self, input_dir, output_dir, product, layer, file_pattern, output_pattern):
    #     file_string = """
    # # extract MODIS {layer}
    # - process: MODIS
    #   type: extract
...
#         return file_string
    ...
    # def generate_download(self, country, download_dir, start_date, end_date):
    #     _year = start_date.strftime("%Y")
    #     _month = start_date.strftime("%m")
    ...
    #         _download_dir = self.vampire.get('MODIS', 'temperature_download_dir')
    #     else:
    ...
    #     return file_string
    #
    # def generate_extract(self, country, data_dir, lst_extract_day_dir, lst_extract_night_dir, start_date):
    #     _year = start_date.strftime("%Y")
    #     _month = start_date.strftime("%m")
    #     _base_date = datetime.datetime.strptime("2000.{0}.01".format(_month), "%Y.%m.%d")
    #     _day_of_year = _base_date.timetuple().tm_yday
...
#         _base_date = datetime.datetime.strptime("2000.{0}.01".format(_month), "%Y.%m.%d")
#         _day_of_year = _base_date.timetuple().tm_yday
#         # TODO: check whether this is correct - if long-term average yr-range start is leap year, need to -1
#         if calendar.isleap(_base_date.year) and _day_of_year > 60:
#             _day_of_year = _day_of_year - 1
#
