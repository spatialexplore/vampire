...
class DSLRAreaImpactProductImpl(ImpactProductImpl.ImpactProductImpl):
    """ Initialise DSLRAreaImpactProductImpl.

    Implementation class for DSLRAreaImpactProduct.
    ...
    def __init__(self, country, valid_from_date, valid_to_date, vampire_defaults):
        super(DSLRAreaImpactProductImpl, self).__init__()
    ...
    # Calculate area impact
        ...
        if output_file is not None:
            ...
            if output_dir is not None:
                ...
                self.output_pattern = self.vp.get('hazard_impact', 'dslr_area_output_pattern')
        ...
        self.publish_pattern = self.vp.get('hazard_impact', 'dslr_area_pattern')
