...
class PublishToGISServerTask(object):
    ...
    def process(self):
        self.move_output_to_geoserver(product=self.params['product'], input_dir=self.params['input_dir'],
                                      input_pattern=self.params['input_pattern'], start_date=self.params['start_date'])
